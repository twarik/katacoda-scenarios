...
mkdir -p /tmp/savedmodel/customerchurn

wget -qO- https://github.com/twarik/maven/blob/main/saved_model_customer_churn/1.zip?raw=true | bsdtar -xvf- -C /tmp/savedmodel/customerchurn
```{{execute}}
